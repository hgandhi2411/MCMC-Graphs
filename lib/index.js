...
function bridgeEdges(graph) {
  console.log('entered bridgeEdges');
  // Here graph is a jsnx graph
...
function deleteEdge(graph) {
  console.log('entered deleteEdge');
  let nodes = graph.nodes();
  let edges = graph.edges();
